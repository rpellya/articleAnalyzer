...
/**
 * PageRank - алгоритм вычисления PageRank в графе по методу итераций оценки вероятности.
 * @param graph количество вершин n, списки исходящих и входящих ссылок, массив степеней вершин
 * @param damping вещественный коэффициент затухания damping ∈ (0, 1)
 * @param iterations целое число итераций iterations >= 1
 * @returns
 */
